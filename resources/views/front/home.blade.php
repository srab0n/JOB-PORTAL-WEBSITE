    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                ...
                <div class="banner-btn mt-5"><a href="{{ url('/jobs') }}" class="btn btn-primary mb-4 mb-sm-0">Explore Now</a></div>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p>{{ Str::words($featuredJob->description, 5) }}.</p> <!-- Limited description to 5 words -->
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p>{{ Str::words($latestjob->description, 5) }}.</p> <!-- Limited description to 5 words -->
                                            <div class="bg-light p-3 border">
                                                <p class="mb-0">
                                                    <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
